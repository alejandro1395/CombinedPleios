...
mkdir -p ${OUTPUT}SinglePleios_MetabolicImmune/
for i in {10..60};
   do mkdir -p ${OUTPUT}SinglePleios_MetabolicImmune/Age_threeshold_${i}/;
	python3 SinglePleiosMetabolicImmune.py ${i} ${OUTPUT}SinglePleios_MetabolicImmune/Age_threeshold_${i}/
    done;
