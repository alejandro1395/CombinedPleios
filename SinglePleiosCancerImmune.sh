...
mkdir -p ${OUTPUT}SinglePleios_CancerImmune/
for i in {10..60};
   do mkdir -p ${OUTPUT}SinglePleios_CancerImmune/Age_threeshold_${i}/;
	python3 SinglePleiosCancerImmune.py ${i} ${OUTPUT}SinglePleios_CancerImmune/Age_threeshold_${i}/
    done;
